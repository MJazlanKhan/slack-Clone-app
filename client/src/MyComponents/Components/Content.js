...
const Content = () => {
  ...
  const loadMessage = async () => {
    ...
    try {
      ...
      const res = await axios.get(`https://slack-clone-app-server.onrender.com/api/v1/message/${selectedChat._id}`, config);
      if (res) {
  ...
  const handleMessage = async () => {
    ...
    try {
      ...
      const res = await axios.post(`https://slack-clone-app-server.onrender.com/api/v1/message`, {
  ...
  const searchUsers = async () => {
    try {
      const response = await axios.get(`https://slack-clone-app-server.onrender.com/api/v1/search?word=${searchWord}`, {
        headers: {
          'user-id': userId
        }
      });
  ...
  const submitData = async () => {
    ...
    try {
      const response = await axios.post('https://slack-clone-app-server.onrender.com/api/v1/group', {
  ...
  const changeGroupPic = async () => {
    ...
    try {
      const res = await axios.post("https://slack-clone-app-server.onrender.com/api/v1/groupPic", {
  ...
  const confirm = async (id) => {
    ...
    const res = await axios.put("https://slack-clone-app-server.onrender.com/api/v1/groupremove", {
  ...
  const addUser = async () => {
    ...
    setLoading("adduser")
    try {
      const res = await axios.put("https://slack-clone-app-server.onrender.com/api/v1/groupadd", {
        chatId: groupChat._id,
        userId: groupUsers
      })
